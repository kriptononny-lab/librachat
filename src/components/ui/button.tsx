...
const buttonVariants = cva(
  [
    ...
    "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-[#040408]",
    ...
    variants: {
      variant: {
        primary: [
          ...
          "", // hover handled by btn-primary-gold
          "active:scale-[0.97]",
        ...
        outline: [
          "border border-[#A78BFA] text-[#C4B5FD]",
        ...
        link: [
          "text-[#C4B5FD] underline-offset-4 hover:underline",
