  ...
  return (
    <footer style={{ marginTop: "auto", background: "#07060e", position: "relative" }}>
      ...
      <div className="container-site" style={{ padding: "56px 0 40px" }}>
        ...
        {/* Основная сетка */}
        <div style={{ display: "grid", gridTemplateColumns: "1.8fr 1fr 1fr 1fr 1fr", gap: "40px", marginBottom: "48px" }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "24px" }}>
            <Link href="/privacy" style={{ fontSize: "13px", color: "#2e2a3e", textDecoration: "none", transition: "color 150ms ease" }}>
              Политика конфиденциальности
            </Link>
            <Link href="/terms" style={{ fontSize: "13px", color: "#2e2a3e", textDecoration: "none", transition: "color 150ms ease" }}>
